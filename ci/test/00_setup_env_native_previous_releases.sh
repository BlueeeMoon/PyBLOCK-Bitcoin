...
export TEST_RUNNER_EXTRA="--previous-releases --coverage --extended --exclude feature_dbcrash,wallet_backwards_compatibility,wallet_inactive_hdchains,mempool_compatibility"  # Run extended tests so that coverage does not fail, but exclude very slow or incompatible tests
