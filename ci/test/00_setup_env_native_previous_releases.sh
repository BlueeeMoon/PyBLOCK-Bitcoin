...
export TEST_RUNNER_EXTRA="--previous-releases --coverage --extended --exclude feature_dbcrash --exclude wallet_backwards_compatibility --exclude wallet_inactive_hdchains"  # Run extended tests so that coverage does not fail, but exclude very slow or incompatible tests
