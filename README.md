...
sudo apt-get install build-essential cmake pkgconf python3 git libevent-dev libboost-dev libsqlite3-dev libzmq3-dev libqrencode-dev imagemagick librsvg2-bin qtcreator libfontconfig1 qtbase5-dev qtchooser qt5-qmake qtbase5-dev-tools libgl-dev libglu-dev libqt5-linguist-devel -y
